...
final class Version20220115011455 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE properties (id INT AUTO_INCREMENT NOT NULL, categories_id INT DEFAULT NULL, propertiesgallery_id INT DEFAULT NULL, user_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, price DOUBLE PRECISION NOT NULL, rooms INT NOT NULL, address VARCHAR(255) NOT NULL, booking INT NOT NULL, city VARCHAR(255) NOT NULL, latitude DOUBLE PRECISION NOT NULL, longitude DOUBLE PRECISION NOT NULL, bedrooms INT NOT NULL, surface INT NOT NULL, reference VARCHAR(255) NOT NULL, picture VARCHAR(255) NOT NULL, country VARCHAR(255) NOT NULL, capacity INT NOT NULL, zip_code INT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_87C331C7A21214B7 (categories_id), INDEX IDX_87C331C71E56FA6E (propertiesgallery_id), INDEX IDX_87C331C7A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
