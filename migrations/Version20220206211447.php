 ...
 */
final class Version20220206211447 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE attributes (id INT AUTO_INCREMENT NOT NULL, categories_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, response_type VARCHAR(20) NOT NULL, required TINYINT(1) NOT NULL, INDEX IDX_319B9E70A21214B7 (categories_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE attributes_answers DROP FOREIGN KEY FK_DCDFCC3CBAAF4009');
        ...
        $this->addSql('ALTER TABLE attributes_answers DROP FOREIGN KEY FK_DCDFCC3C3691D1CA');
